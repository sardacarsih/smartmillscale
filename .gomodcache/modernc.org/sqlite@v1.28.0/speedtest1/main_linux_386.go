	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23487) == 0 {
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23525, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23602) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23606) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23525, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23688) == 0 {
					g.hashFile = libc.Xstdout
				} else {
					g.hashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23690)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23693, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23723) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23525, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				if g.pScript != 0 {
					libc.Xfclose(tls, g.pScript)
				}
				g.pScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)), ts+23690)
				if g.pScript == uintptr(0) {
					fatal_error(tls, ts+23810, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23983) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23525, libc.VaList(bp+168, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
