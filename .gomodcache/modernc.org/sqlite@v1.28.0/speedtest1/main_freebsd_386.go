...
func HashInit(tls *libc.TLS) {
	...
	for k = uint32(0); k < uint32(256); k++ {
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(k))) = uint8(k)
	}
}
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for k = uint32(0); k < nData; k++ {
		j = uint8(int32(j) + (int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(i)))) + int32(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(j))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(i)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(i))) = t
		i++
	}
	g.hash.i = i
	g.hash.j = j
...
func HashFinal(tls *libc.TLS) {
	...
	for k = uint32(0); k < uint32(32); k++ {
		i++
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(i)))
		j = uint8(int32(j) + int32(t))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(i))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(j))) = t
		t = uint8(int32(t) + int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(i)))))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 259 + uintptr(k))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 3 + uintptr(t)))
	}
}
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.bVerify != 0 {
		...
		HashFinal(tls)
		for i = 0; i < 24; i++ {
			libc.Xprintf(tls, ts+3056, libc.VaList(bp+40, int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3112 + 259 + uintptr(i))))))
		}
			...
			if g.bVerify != 0 {
				...
				*(*uint8)(unsafe.Pointer(bp + 8 + 1)) = uint8(*(*int8)(unsafe.Pointer(ts + 3163 + uintptr(eType))))
				...
				if eType == SQLITE_FLOAT {
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 92)) += uint64(2)
					...
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 92)) += u64(nBlob*2 + 2)
				} else {
					HashUpdate(tls, z, uint32(len))
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 92)) += u64(len + 2)
				}
			}
			if uint32(g.nResult+len) < uint32(unsafe.Sizeof([3000]int8{}))-uint32(2) {
				if g.nResult > 0 {
					*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 104 + uintptr(libc.PostIncInt32(&g.nResult, 1)))) = int8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+104+uintptr(g.nResult), z, uint32(len+1))
				*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 100)) += len
			}
		}
	}
	if g.bReprepare != 0 {
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	for i = uint32(0); i < n; i++ {
		...
		speedtest1_run(tls)
		*(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+104)
	}
	speedtest1_end_test(tls)
	...
	if g.bVerify != 0 {
		...
		for i = uint32(0); i < n; i++ {
			...
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
			speedtest1_run(tls)
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+104) {
				fatal_error(tls, ts+10353,
					libc.VaList(bp+16, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+104)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	if g.bVerify != 0 {
		...
		for i = uint32(0); i < n; i++ {
			...
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+104) {
				fatal_error(tls, ts+10353,
					libc.VaList(bp+64, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+104)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	for i = uint32(0); i < n; i++ {
		...
		if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+104) {
			fatal_error(tls, ts+10353,
				libc.VaList(bp+112, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+104)))
		}
	}
	speedtest1_end_test(tls)
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23214) == 0 {
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23252, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23329) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23333) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23252, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23415) == 0 {
					g.hashFile = libc.X__stdoutp
				} else {
					g.hashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23417)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23420, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23450) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-2 {
					fatal_error(tls, ts+23252, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				if g.pScript != 0 {
					libc.Xfclose(tls, g.pScript)
				}
				g.pScript = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)), ts+23417)
				if g.pScript == uintptr(0) {
					fatal_error(tls, ts+23537, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zVfs = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23710) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23252, libc.VaList(bp+168, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
