...
func __sbmaskrune_l(tls *libc.TLS, __c int32, __f uint64, __loc locale_t) int32 {
	bp := tls.Alloc(4)
	defer tls.Free(4)
...
func __sbistype_l(tls *libc.TLS, __c int32, __f uint64, __loc locale_t) int32 {
